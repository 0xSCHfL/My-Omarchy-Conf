...
static const char col_s_sep[]       = "#555555";  /* status: dim separator */
static const char col_s_icon[]      = "#81a1c1";  /* status: Nord frost blue icons */
static const char col_s_val[]       = "#eceff4";  /* status: Nord snow white values */
static const char col_s_warn[]      = "#ebcb8b";  /* status: Nord aurora yellow warning */
...
static const char *cliphistcmd[]    = { "/bin/sh", "-c", "txtcliphist sel", NULL };
